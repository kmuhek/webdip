...
<head>
    <title>Razlog odustajanja</title>
    <meta charset="UTF-8" />
...
<body>
    <header class="headerGrid">
        <div id="izbornik" class="izbornik">
            <div class="zatvoriGumbPozicija">
                <a href="index.html"><img class="logo" src="../multimedija/logo.png" /></a>
        ...
        <h1 class="naslov">Razlog odustajanja</h1>
    ...
    <main class="formaPrijava formaSlika">
        <form class="formaLokacija" method="POST" id="formaRazlog" name="formaRazlog" action="../php/razlogOdustajanjaBaza.php">
            <label for="razlogOdustajanja">Razlog odustajanja:</label><br>
            <textarea type="file" rows="5" cols="30" name="razlogOdustajanja" id="razlogOdustajanja"></textarea>
