...
<html lang="hr">
  <head>
    <title>Otkljucavanje/blokiranje</title>
    <meta charset="UTF-8" />
    ...
    <script defer src="../javascript/blokiraniAdmin.js"></script>
  </head>
  <body>
  <header class="headerGrid">
      ...
      <h1 class="naslov">Otključavanje/blokiranje</h1>
      ...
      <div class="pozicijaTablica">
        <div class="overflowTablica">
          <table class="tablica" id="tablica">
            <caption>
              Blokiranje/otključavanje korisnika
            </caption>
            <thead class="zaglavljeTablice">
              <tr>
                <td name="korime">Korisničko ime</td>
                <td>Status</td>
                <td>Blokiranje</td>
                <td>Otključavanje</td>
              </tr>
