...
<header class="headerGrid">
      ...
      <h1 class="naslov">Upload slike</h1>
    ...
    <form class="formaLokacija" enctype="multipart/form-data" method="POST" id="formaSlika" name="formaSlika" action="../php/uploadSlikeBaza.php">
        <label for="slika">Slika:</label><br>
        <input type="file" name="slika" id="slika"><br>
        <input type="hidden" name="utrkaId" id="utrkaId" value="<?php echo $utrkaId ?>">
